  ...
  switch (chain) {
    case mainnet:
      return new RpcProvider({
        nodeUrl: import.meta.env.NEXT_PUBLIC_RPC_MAINNET,
      });
    case sepolia:
    default:
      return new RpcProvider({
        nodeUrl: import.meta.env.NEXT_PUBLIC_RPC_SEPOLIA,
      });
  }
}
...
const connectors = [
  new CartridgeConnector(
    ...
    {
      url,
      rpc: import.meta.env.NEXT_PUBLIC_RPC_SEPOLIA,
      // paymaster: {
