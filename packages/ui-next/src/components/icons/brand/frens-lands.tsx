  ...
  forwardRef<SVGSVGElement, IconProps>(
    ({ className, size, ...props }, forwardedRef) => (
      ...
      >
        ...
        />
        <path
          d="M14.9959 4H16.6859V5.58559H14.9959V4Z"
          className="fill-current"
        />
        <path
          d="M13.4596 4H15.1496V5.58559H13.4596V4Z"
          className="fill-current"
        />
        <path
          d="M11.9232 4H13.6132V5.58559H11.9232V4Z"
          className="fill-current"
        />
        <path
          d="M10.3869 4H12.0769V5.58559H10.3869V4Z"
          className="fill-current"
        />
        <path
          d="M8.85053 4H10.5405V5.58559H8.85053V4Z"
          className="fill-current"
        />
        <path
          d="M7.31418 4H9.00417V5.58559H7.31418V4Z"
          className="fill-current"
        />
        <path
...
FrensLandsIcon.displayName = "FrensLandsIcon";
